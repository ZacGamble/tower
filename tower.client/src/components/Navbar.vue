    ...
    <div class="modal-content">
      ...
      <div class="event-modal-body">
        <form class="p-4" @submit.prevent="createTowerEvent()">
          <div class="d-flex">
          <input class="m-2 p-2 rounded" type="text" placeholder="name..." v-model="editable.name">
          <input class="m-2 p-2 rounded" type="url" placeholder="cover image URL..." v-model="editable.coverImg">
          </div>
          <div class="d-flex">
          <input class="m-2 p-2 rounded" type="text" placeholder="location..." v-model="editable.location">
          <input class="m-2 p-2 rounded" type="number" placeholder="capacity" v-model="editable.capacity">
          </div>
